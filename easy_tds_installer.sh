...
printf '%s\n' '$c .= "    \$db->exec(\"CREATE TABLE IF NOT EXISTS goals (id INTEGER PRIMARY KEY AUTOINCREMENT, stream_id INTEGER NOT NULL, name TEXT NOT NULL, param_name TEXT NOT NULL, value_type TEXT NOT NULL DEFAULT '"'"'flag'"'"', is_revenue INTEGER DEFAULT 0)\");\n";' >> $MCP
